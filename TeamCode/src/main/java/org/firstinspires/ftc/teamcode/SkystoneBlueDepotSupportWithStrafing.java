...
@Disabled
@Autonomous(name = "Skystone Blue Depot Support With Strafing", group = "Beep")
public class SkystoneBlueDepotSupportWithStrafing extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.leftFront.setTargetPosition(5500);
        robot.rightBack.setTargetPosition(5500);
        ...
        robot.leftFront.setTargetPosition(-5700);
        robot.rightBack.setTargetPosition(-5700);
